...
namespace TAE
{
    ...
    public class GasPropertyExtension : DefModExtension
    {
    ...
    {
        private GasPropertyExtension props;
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            props = def.GetModExtension<GasPropertyExtension>();
        ...
        public override void Tick()
        {
            ...
            if (room != null)
            {
                var pollution = Map.GetMapInfo<AtmosphericMapInfo>().ComponentAt(room);
                if (!false) //pollution.CurrentContainer.FullySaturated
                {
                    //!Position.Roofed(Map) &&
        ...
        private bool CanSpreadTo(IntVec3 other, out float passPct)
        {
            ...
            passPct = AtmosphericTransferWorker.AtmosphericPassPercent(other.GetFirstBuilding(Map));
            return passPct > 0;
        }
